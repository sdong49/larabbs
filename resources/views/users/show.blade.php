...
<div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    <div class="card ">
      <div class="card-body">
          <h1 style="font-size:22px;">Espace personnel de {{ $user->name }} <small>{{ $user->email }}</small> </h1>
          <a style="margin-top: 20px" class="btn btn-dark" href="{{ route('users.edit', Auth::id()) }}" role="button">Modifier votre information</a>
      </div>
    </div>
    <hr>
